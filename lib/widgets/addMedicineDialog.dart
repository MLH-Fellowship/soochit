            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  _CupertinoTextFieldPres(placeholderTextIndex: 0, textInputType: TextInputType.text,),
                  MySpaces.vGapInBetween,
                  _CupertinoTextFieldPres(placeholderTextIndex: 1, textInputType: TextInputType.text,),
                  MySpaces.vGapInBetween,
                  Row(
...
class _CupertinoTextFieldPres extends StatelessWidget {
  ...
  _CupertinoTextFieldPres({@required this.placeholderTextIndex, @required this.textInputType});
